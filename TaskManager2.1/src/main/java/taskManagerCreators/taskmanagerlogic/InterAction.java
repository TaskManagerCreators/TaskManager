...
import taskManagerCreators.config.DatabaseConfiguration;
...
@ComponentScan({"taskManagerCreators.taskmanagerlogic", "taskManagerCreators.commands", "taskManagerCreators.controller"})
